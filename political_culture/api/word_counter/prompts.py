TEXT_INFO_EXTRACTION_PROMPT = (
    ...
    "• Always ask yourself: \u201cWould this exact phrase probably"
    " appear *verbatim* in the text?\u201d\n"
    "  1. **High-recall probes** – up to three broad terms such as "
    "     «introduction», «abstract», «chapter», «conclusion», or any obvious "
    "     title words.\n"
    "     obvious title words.\n"
    "     then use those phrases as the next queries. Repeat until further"
    "     calls add no new information. Also, do not make the same query twice.\n"
...
STRUCTURED_OUTPUT_PROMPT = (
    ...
    "\n1. Identify the *title*, *author*, and *description* exactly as they appear in"
    " the input—do **not** paraphrase, edit, truncate, expand, or otherwise change"
    " the wording."
    "\n2. Copy each element verbatim into the corresponding fields of the structured"
    " output format that will be supplied. "
    "Leave any field empty or `null` if the information is genuinely missing."
    "\n\n**Do not perform any additional summarization, rewriting, spell-checking, or"
    " interpretation.** Your role is strictly to map the existing content into the"
    " schema."
)
...
WORD_EXTRACTION_PROMPT = (
    ...
    "\n1. A context summary describing the content, topic, genre, entities, tone,"
    " and structure of a document."
    "\n2. A list of words extracted from the document, each with its frequency of"
    " occurrence."
    "\n\nYour task is to identify and return only the words that are contextually"
    " relevant to the document, based on the information provided in the summary."
    ...
    "\n3) Are important for understanding the content, structure, or intent of the"
    " document."
    "\n4) May include uncommon or high-signal terms, even if they are low in"
    " frequency."
    "\nDo not return general-purpose or filler words (e.g., 'the', 'also', 'very')"
    " unless they carry domain-specific importance."
